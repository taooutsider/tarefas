# Bittensor Field College curriculum

Working name: Bittensor Field College
...
1. Open `/field-school/` and the individual module URL in local preview.
2. Review one module per pass for source quality, field exercise, quiz, navigation and visible copy.
3. Mark one of three decisions in the review queue: approved, revise, hold.
4. Published modules stay `draft: false`; corrections are patched in place.
5. Before deploy, run `npm run predeploy:field-college` and the article scanner for changed modules.

## Publishing rhythm

Recommended cadence: the full course is live, so the publishing focus moves to supporting articles, module updates and case studies.

Reason: the course now works as a permanent knowledge hub. Fresh posts should send readers back into the right module, and module updates should happen when the protocol, tools or field evidence changes.
...
2. Bittensor is an intelligence market
   Date: 2026-06-15
   Cluster: first principles
   Primary keyword: Bittensor intelligence market
   Public URL: /blog/bittensor-field-school-intelligence-market/
   Status: published
   Summary: Learn why Bittensor should be read as a live market for machine intelligence, with workers, judges, incentives, capital and evidence.

3. Subnets are incentive machines
   Date: 2026-06-06
   Cluster: subnets
   Primary keyword: Bittensor subnets explained
   Review URL: /blog/bittensor-field-school-subnets/
...
4. Miners are workers with an optimization problem
   ...
   Review URL: /blog/bittensor-field-school-miners/
...
5. Validators are judges with capital behind them
   ...
   Review URL: /blog/bittensor-field-school-validators/
...
6. Yuma turns opinions into emissions
   ...
   Review URL: /blog/bittensor-field-school-yuma/
...
7. The weight copying problem is the hidden tax on lazy validation
   ...
   Review URL: /blog/bittensor-field-school-weight-copying/
...
8. Every subnet is only as good as its scoring model
   ...
   Review URL: /blog/bittensor-field-school-incentive-mechanisms/
...
9. Multiple mechanisms let a subnet pay for more than one kind of work
   ...
   Review URL: /blog/bittensor-field-school-multiple-mechanisms/
...
10. The metagraph is the subnet truth table
   ...
   Review URL: /blog/bittensor-field-school-metagraph/
...
11. Hotkeys and coldkeys explain who can act and who owns
   ...
   Review URL: /blog/bittensor-field-school-hotkeys-coldkeys/
...
12. Root is the subnet for people who do not want to pick a subnet yet
   ...
   Review URL: /blog/bittensor-field-school-root-subnet/
...
13. Staking is voting with exposure
   ...
   Review URL: /blog/bittensor-field-school-staking/
...
14. dTAO changed the center of gravity
   ...
   Review URL: /blog/bittensor-field-school-dtao-taoflow/
...
15. Alpha tokens are claims on subnet specific belief
   ...
   Review URL: /blog/bittensor-field-school-alpha-tokens/
...
16. The subnet AMM makes every stake a price event
   ...
   Review URL: /blog/bittensor-field-school-amm-pools/
...
17. Slippage is the cost of being too large for the pool
   ...
   Review URL: /blog/bittensor-field-school-slippage/
...
18. Emissions are the payroll of the network
   ...
   Review URL: /blog/bittensor-field-school-emissions/
...
19. TaoFlow made inflow and outflow the scoreboard
   ...
   Review URL: /blog/bittensor-field-school-taoflow/
...
20. Conviction is commitment with a clock attached
   ...
   Review URL: /blog/bittensor-field-school-conviction/
...
21. Subnet registration is the cost of opening a new arena
   ...
   Review URL: /blog/bittensor-field-school-subnet-registration/
...
22. Deregistration is how the network makes room
   ...
   Review URL: /blog/bittensor-field-school-deregistration/
...
23. Hyperparameters are the rule sheet under the scoreboard
   ...
   Review URL: /blog/bittensor-field-school-hyperparameters/
...
24. A subnet GitHub can tell you what the website hides
   ...
   Review URL: /blog/bittensor-field-school-subnet-code/
...
25. A subnet without a product surface needs a harder question
   ...
   Review URL: /blog/bittensor-field-school-product-surface/
...
26. TAO.app is the official front door
   ...
   Review URL: /blog/bittensor-field-school-tao-app/
...
27. TaoSwap shows the market as a living table
   ...
   Review URL: /blog/bittensor-field-school-taoswap/
...
28. TaoFlows turns staking into a tape
   ...
   Review URL: /blog/bittensor-field-school-taoflows/
...
29. Backprop is a screener for the dTAO market
   ...
   Review URL: /blog/bittensor-field-school-backprop/
...
30. SubnetRadar is for risk and anomaly hunting
   ...
   Review URL: /blog/bittensor-field-school-subnetradar/
...
31. AlphaGap reads what investors miss between code and market
   ...
   Review URL: /blog/bittensor-field-school-alphagap/
...
32. IntoTao is the ecosystem map for newcomers
   ...
   Review URL: /blog/bittensor-field-school-intotao/
...
33. TaoStats is the encyclopedia with an API spine
   ...
   Review URL: /blog/bittensor-field-school-taostats/
...
34. APIs turn Bittensor from story into evidence
   ...
   Review URL: /blog/bittensor-field-school-tao-api/
...
35. Subnet categories are useful until they become lazy
   ...
   Review URL: /blog/bittensor-field-school-subnet-categories/
...
36. LLM subnets compete on routing, quality and cost
   ...
   Review URL: /blog/bittensor-field-school-llm-subnets/
...
37. Compute subnets sell capacity and reliability
   ...
   Review URL: /blog/bittensor-field-school-compute-subnets/
...
38. Data subnets live or die by provenance and demand
   ...
   Review URL: /blog/bittensor-field-school-data-subnets/
...
39. Agent subnets should be judged by tasks completed
   ...
   Review URL: /blog/bittensor-field-school-agent-subnets/
...
40. Media subnets turn attention into a measurable commodity
   ...
   Review URL: /blog/bittensor-field-school-media-subnets/
...
41. Financial subnets need risk language, not hype language
   ...
   Review URL: /blog/bittensor-field-school-defi-subnets/
...
42. The red flags that make a subnet hard to trust
   ...
   Review URL: /blog/bittensor-field-school-red-flags/
...
43. A fragile subnet can still be honest
   ...
   Review URL: /blog/bittensor-field-school-scam-vs-fragile/
...
44. Validator selection is delegated judgment
   ...
   Review URL: /blog/bittensor-field-school-validator-selection/
...
45. Yield without context is the easiest trap in TAO
   ...
   Review URL: /blog/bittensor-field-school-yield/
...
46. Wallet flows reveal behavior before explanations do
   ...
   Review URL: /blog/bittensor-field-school-wallet-analysis/
...
47. GitHub research is a habit more than a metric
   ...
   Review URL: /blog/bittensor-field-school-github-research/
...
48. How to write a subnet thesis without fooling yourself
   ...
   Review URL: /blog/bittensor-field-school-writing-thesis/
...
49. Build your Bittensor research terminal
   ...
   Review URL: /blog/bittensor-field-school-research-terminal/
...
50. The subnet thesis exam
   ...
   Review URL: /blog/bittensor-field-school-thesis-exam/
