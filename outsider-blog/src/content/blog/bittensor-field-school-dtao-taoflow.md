...
draft: true
author: "Tao Outsider"
tags: ["TAO", "Bittensor", "Field School", "dTAO", "dTAO explained"]
...
<section class="knowledge-check" data-quiz>
  ...
  <fieldset data-answer="b">
    ...
    <label><input type="radio" name="q13a" value="a" /> Memorize the most popular explanation.</label>
    <label><input type="radio" name="q13a" value="b" /> Translate the idea into something you can inspect.</label>
    <label><input type="radio" name="q13a" value="c" /> Pick the subnet with the loudest story.</label>
  </fieldset>
  <fieldset data-answer="a">
    <legend>What should you do when the narrative and the data disagree?</legend>
    <label><input type="radio" name="q13b" value="a" /> Slow down and inspect the mechanism, flows and evidence.</label>
    <label><input type="radio" name="q13b" value="b" /> Ignore the data if the team sounds confident.</label>
    <label><input type="radio" name="q13b" value="c" /> Wait for social media to decide.</label>
  </fieldset>
  <fieldset data-answer="c">
    <legend>What makes a Tao Outsider reader different?</legend>
    <label><input type="radio" name="q13c" value="a" /> They collect more tabs than everyone else.</label>
    <label><input type="radio" name="q13c" value="b" /> They memorize ticker symbols.</label>
    <label><input type="radio" name="q13c" value="c" /> They can explain the work, the incentive and the risk in plain English.</label>
  </fieldset>
...
<nav class="course-nav" aria-label="Field School navigation">
  <a href="/field-school/review/bittensor-field-school-staking/">Previous: Staking is voting with exposure</a>
  <a href="/field-school/review/bittensor-field-school-alpha-tokens/">Next: Alpha tokens are claims on subnet specific belief</a>
</nav>
