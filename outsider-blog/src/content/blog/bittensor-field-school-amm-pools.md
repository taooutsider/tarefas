---
title: "The subnet AMM makes every stake a price event"
description: "Bittensor subnet tokens use pools where liquidity, price and slippage shape what a position really means."
pubDate: 2026-06-28T12:00:00.000Z
category: guide
featured: false
draft: true
author: "Tao Outsider"
tags: ["TAO", "Bittensor", "Field School", "markets", "Bittensor subnet AMM"]
image: "/blog/bittensor-field-school/bittensor-field-school-amm-pools-lesson.svg"
imageAlt: "The subnet AMM makes every stake a price event"
ogImage: "/blog/bittensor-field-school/bittensor-field-school-amm-pools-og.jpg"
---

![The subnet AMM makes every stake a price event](/blog/bittensor-field-school/bittensor-field-school-amm-pools-lesson.svg)
...
Teach price as pool geometry, not a number on a screen.
...
<section class="knowledge-check" data-quiz>
  ...
  <fieldset data-answer="b">
    ...
    <label><input type="radio" name="q15a" value="a" /> Memorize the most popular explanation.</label>
    <label><input type="radio" name="q15a" value="b" /> Translate the idea into something you can inspect.</label>
    <label><input type="radio" name="q15a" value="c" /> Pick the subnet with the loudest story.</label>
  </fieldset>
  <fieldset data-answer="a">
    <legend>What should you do when the narrative and the data disagree?</legend>
    <label><input type="radio" name="q15b" value="a" /> Slow down and inspect the mechanism, flows and evidence.</label>
    <label><input type="radio" name="q15b" value="b" /> Ignore the data if the team sounds confident.</label>
    <label><input type="radio" name="q15b" value="c" /> Wait for social media to decide.</label>
  </fieldset>
  <fieldset data-answer="c">
    <legend>What makes a Tao Outsider reader different?</legend>
    <label><input type="radio" name="q15c" value="a" /> They collect more tabs than everyone else.</label>
    <label><input type="radio" name="q15c" value="b" /> They memorize ticker symbols.</label>
    <label><input type="radio" name="q15c" value="c" /> They can explain the work, the incentive and the risk in plain English.</label>
  </fieldset>
...
<nav class="course-nav" aria-label="Field School navigation">
  <a href="/field-school/review/bittensor-field-school-alpha-tokens/">Previous: Alpha tokens are claims on subnet specific belief</a>
  <a href="/field-school/review/bittensor-field-school-slippage/">Next: Slippage is the cost of being too large for the pool</a>
</nav>
