...
draft: true
author: "Tao Outsider"
tags: ["TAO", "Bittensor", "Field School", "builders", "Bittensor subnet hyperparameters"]
...
<section class="knowledge-check" data-quiz>
  ...
  <fieldset data-answer="b">
    ...
    <label><input type="radio" name="q22a" value="a" /> Memorize the most popular explanation.</label>
    <label><input type="radio" name="q22a" value="b" /> Translate the idea into something you can inspect.</label>
    <label><input type="radio" name="q22a" value="c" /> Pick the subnet with the loudest story.</label>
  </fieldset>
  <fieldset data-answer="a">
    <legend>What should you do when the narrative and the data disagree?</legend>
    <label><input type="radio" name="q22b" value="a" /> Slow down and inspect the mechanism, flows and evidence.</label>
    <label><input type="radio" name="q22b" value="b" /> Ignore the data if the team sounds confident.</label>
    <label><input type="radio" name="q22b" value="c" /> Wait for social media to decide.</label>
  </fieldset>
  <fieldset data-answer="c">
    <legend>What makes a Tao Outsider reader different?</legend>
    <label><input type="radio" name="q22c" value="a" /> They collect more tabs than everyone else.</label>
    <label><input type="radio" name="q22c" value="b" /> They memorize ticker symbols.</label>
    <label><input type="radio" name="q22c" value="c" /> They can explain the work, the incentive and the risk in plain English.</label>
  </fieldset>
...
<nav class="course-nav" aria-label="Field School navigation">
  <a href="/field-school/review/bittensor-field-school-deregistration/">Previous: Deregistration is how the network makes room</a>
  <a href="/field-school/review/bittensor-field-school-subnet-code/">Next: A subnet GitHub can tell you what the website hides</a>
</nav>
