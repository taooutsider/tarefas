---
title: "Metanova Labs and NOVA: the Bittensor subnet turning drug discovery into a competition"
...
[Metanova Labs](https://www.metanova-labs.ai/about) describes itself as a crypto native biotech company focused on drug discovery. Its public language is unusually specific for a Bittensor project: the company says it is developing therapeutics that regulate mental states and restore critical biological processes.
...
Metanova wants to use decentralized compute and collective intelligence to explore chemical spaces that are too large for traditional brute force search. On Bittensor, that becomes [NOVA](https://www.metanova-labs.ai/nova), Subnet 68, a decentralized drug discovery subnet where participants compete to generate better molecular candidates and better search strategies.
...
The official [Metanova whitepaper page](https://www.metanova-labs.ai/whitepapers) describes NOVA as a self improving, adversarial, and model agnostic drug discovery engine. That language matters because the project is aiming beyond a few interesting molecules. The larger goal is a repeated competition layer for better discovery.

The [GitHub repository](https://github.com/metanova-labs/nova) also shows a real implementation surface. It describes NOVA as high throughput machine learning driven drug screening powered by Bittensor, with validator and miner setup instructions, GPU related requirements, and active code history.
...
Sources: [Metanova Labs about page](https://www.metanova-labs.ai/about), [NOVA official page](https://www.metanova-labs.ai/nova), [NOVA whitepapers](https://www.metanova-labs.ai/whitepapers), [Metanova Labs NOVA GitHub](https://github.com/metanova-labs/nova), [SubnetSummer Proof of Talk broadcast](https://x.com/i/broadcasts/1aJbddZDAbkKX), [Tao Media on the Metanova and ONEPOT.AI partnership](https://www.tao.media/metanova-partners-with-onepot-ai-to-accelerate-drug-discovery-on-bittensor/), [Bittensor.ai learning hub on SN68](https://www.bittensor.ai/learning-hub/sn68-metanova-labs), [Crypto Briefing on SN68 Metanova](https://cryptobriefing.com/bittensor-sn68-metanova-drug-discovery/).
