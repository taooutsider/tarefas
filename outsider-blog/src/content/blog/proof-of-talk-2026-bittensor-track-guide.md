---
title: "Proof of Talk 2026: remote Bittensor track guide"
description: "Tao Outsider's remote guide to the Proof of Talk 2026 Bittensor Track, including sessions, subnets, X coverage, and stream status."
...
image: "/blog/proof-of-talk-bittensor/proof-of-talk-bittensor-2026.svg"
imageAlt: "Tao Outsider guide cover for the Proof of Talk 2026 Bittensor Track"
ogImage: "/blog/proof-of-talk-bittensor/proof-of-talk-bittensor-2026-og.jpg"
---

![Tao Outsider guide cover for the Proof of Talk 2026 Bittensor Track](/blog/proof-of-talk-bittensor/proof-of-talk-bittensor-2026.svg)
...
[Proof of Talk 2026](https://proofoftalk.io/) is taking place at the Louvre Palace in Paris on June 2 and 3, 2026.
...
The official [Bittensor Track page](https://proofoftalk.io/bittensor/) lists a full two day program around Bittensor, decentralized AI, subnet businesses, institutional capital, agentic AI, TensorFi, mining pools, enterprise adoption, and Proof of Pitch with Bitstarter.
...
The X profile to monitor is [@taostats](https://x.com/taostats).
...
The X profile to monitor is [@bitstarterAI](https://x.com/bitstarterAI).
...
The X profile to monitor is [@generaltensor](https://x.com/generaltensor).
...
The X profile to monitor is [@manifoldlabs](https://x.com/manifoldlabs).
...
The X profiles to monitor are [@DendriteHQ](https://x.com/DendriteHQ) and [@SomaSubnet](https://x.com/SomaSubnet).
...
The X profile to monitor is [@YumaGroup](https://x.com/YumaGroup).
...
The X profile to monitor is [@ExploitSummit](https://x.com/ExploitSummit).
...
The X profile to monitor is [@bitmind](https://x.com/bitmind).
...
The X profile to monitor is [@Bitcast_network](https://x.com/Bitcast_network).
...
The X profile to monitor is [@vidaio_](https://x.com/vidaio_).
...
The X profile to monitor is [@resilabsai](https://x.com/resilabsai).
...
The X profile to monitor is [@hippius_subnet](https://x.com/hippius_subnet).
...
The X profiles to monitor are [@metanova_labs](https://x.com/metanova_labs) and [@micaelabazo](https://x.com/micaelabazo).
...
The X profile to monitor is [@webuildscore](https://x.com/webuildscore).
...
The X profile to monitor is [@oroagents](https://x.com/oroagents).
...
The X profiles to monitor are [@btlabs_ai](https://x.com/btlabs_ai) and Jose Rios at [@SiliconJose](https://x.com/SiliconJose).
...
The X profile to monitor is [@crunchdao](https://x.com/crunchdao).
...
1. Check [Proof of Talk on X](https://x.com/proofoftalk) before each major Bittensor session.
2. Check [Bitstarter on X](https://x.com/bitstarterAI) before the June 3 Proof of Pitch session.
3. Check [Taostats on X](https://x.com/taostats) because it is central to the track, the stage, and the side event.
...
This is where our recent [Conviction article](/blog/bittensor-conviction-explained/) becomes relevant.
...
Start with the official accounts: [Proof of Talk](https://x.com/proofoftalk), [OpenTensor Foundation](https://x.com/opentensor), [Taostats](https://x.com/taostats), [Bitstarter](https://x.com/bitstarterAI), [Yuma](https://x.com/YumaGroup), and [General Tensor](https://x.com/generaltensor).
...
1. [Proof of Talk official site](https://proofoftalk.io/) checked on June 1, 2026.
2. [Proof of Talk Bittensor Track page](https://proofoftalk.io/bittensor/) checked on June 1, 2026.
3. [Official Bittensor Side Event on Luma](https://luma.com/du69wgko) checked on June 1, 2026.
4. [Tao Times media partner note](https://tao-times.beehiiv.com/p/tao-times-x-proof-of-talk) checked on June 1, 2026.
5. [Bitstarter X profile](https://x.com/bitstarterAI) checked on June 1, 2026.
