---
title: "Emissions are the payroll of the network"
description: "TAO and alpha emissions decide who gets paid, what gets reinforced and what dies quietly."
pubDate: 2026-07-02T12:00:00.000Z
category: guide
featured: false
draft: true
author: "Tao Outsider"
tags: ["TAO", "Bittensor", "Field School", "emissions", "Bittensor emissions explained"]
image: "/blog/bittensor-field-school/bittensor-field-school-emissions-lesson.svg"
imageAlt: "Emissions are the payroll of the network"
ogImage: "/blog/bittensor-field-school/bittensor-field-school-emissions-og.jpg"
---

![Emissions are the payroll of the network](/blog/bittensor-field-school/bittensor-field-school-emissions-lesson.svg)
...
Readers should trace emissions from subnet flow into participants.
...
<section class="knowledge-check" data-quiz>
  ...
  <fieldset data-answer="b">
    ...
    <label><input type="radio" name="q17a" value="a" /> Memorize the most popular explanation.</label>
    <label><input type="radio" name="q17a" value="b" /> Translate the idea into something you can inspect.</label>
    <label><input type="radio" name="q17a" value="c" /> Pick the subnet with the loudest story.</label>
  </fieldset>
  <fieldset data-answer="a">
    <legend>What should you do when the narrative and the data disagree?</legend>
    <label><input type="radio" name="q17b" value="a" /> Slow down and inspect the mechanism, flows and evidence.</label>
    <label><input type="radio" name="q17b" value="b" /> Ignore the data if the team sounds confident.</label>
    <label><input type="radio" name="q17b" value="c" /> Wait for social media to decide.</label>
  </fieldset>
  <fieldset data-answer="c">
    <legend>What makes a Tao Outsider reader different?</legend>
    <label><input type="radio" name="q17c" value="a" /> They collect more tabs than everyone else.</label>
    <label><input type="radio" name="q17c" value="b" /> They memorize ticker symbols.</label>
    <label><input type="radio" name="q17c" value="c" /> They can explain the work, the incentive and the risk in plain English.</label>
  </fieldset>
...
<nav class="course-nav" aria-label="Field School navigation">
  <a href="/field-school/review/bittensor-field-school-slippage/">Previous: Slippage is the cost of being too large for the pool</a>
  <a href="/field-school/review/bittensor-field-school-taoflow/">Next: TaoFlow made inflow and outflow the scoreboard</a>
</nav>
