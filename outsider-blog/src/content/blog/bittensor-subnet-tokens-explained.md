...
image: "/blog/basic-seo/bittensor-subnet-tokens-explained-og.jpg"
imageAlt: "Tao Outsider Bittensor basic guide"
ogImage: "/blog/basic-seo/bittensor-subnet-tokens-explained-og.jpg"
---

# Bittensor subnet tokens explained

## Fast answer

Bittensor subnet tokens are alpha tokens tied to individual subnets. They let the market price subnet specific exposure instead of treating all subnet activity as one TAO level signal.

This article is for the reader searching "Bittensor subnet tokens" and trying to avoid the usual shortcut explanations. The goal is a clean starting point, then a practical path for checking the claim inside the Bittensor ecosystem.

## Plain English version

Under dTAO, subnet markets have TAO and alpha liquidity. Stakers can choose exposure to particular subnet economies. Price, liquidity and emissions interact inside those markets.
...
People search for Bittensor subnet tokens because Bittensor can sound simple from far away and complex as soon as they open the first dashboard. The words repeat everywhere: TAO, subnet, miner, validator, alpha, Root, dTAO, Yuma, staking.
...
A subnet token differs from owning the whole subnet. The user gets exposure to that subnet market and its token behavior.
...
1. Check the alpha price.
2. Check TAO liquidity in the pool.
3. Estimate slippage before entry.
4. Read the subnet mechanism before trusting price.
