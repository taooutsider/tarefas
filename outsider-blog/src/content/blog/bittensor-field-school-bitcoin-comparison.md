---
title: "Why the Bitcoin comparison helps and then breaks"
description: "Use Bitcoin as a starting mirror, then separate monetary security from programmable work markets."
pubDate: 2026-06-04T12:00:00.000Z
category: guide
featured: false
draft: true
author: "Tao Outsider"
tags: ["TAO", "Bittensor", "Field School", "first principles", "Bittensor Bitcoin comparison"]
image: "/blog/bittensor-field-school/bittensor-field-school-bitcoin-comparison-lesson.svg"
imageAlt: "Why the Bitcoin comparison helps and then breaks"
ogImage: "/blog/bittensor-field-school/bittensor-field-school-bitcoin-comparison-og.jpg"
---

![Why the Bitcoin comparison helps and then breaks](/blog/bittensor-field-school/bittensor-field-school-bitcoin-comparison-lesson.svg)

<section class="field-note">

## The point of this lesson

Use Bitcoin as a starting mirror, then separate monetary security from programmable work markets.
...
The useful comparison is issuance and open participation. The dangerous comparison is pretending the outputs are the same.
...
<section class="knowledge-check" data-quiz>
  ...
  <fieldset data-answer="b">
    ...
    <label><input type="radio" name="q1a" value="a" /> Memorize the most popular explanation.</label>
    <label><input type="radio" name="q1a" value="b" /> Translate the idea into something you can inspect.</label>
    <label><input type="radio" name="q1a" value="c" /> Pick the subnet with the loudest story.</label>
  </fieldset>
  <fieldset data-answer="a">
    <legend>What should you do when the narrative and the data disagree?</legend>
    <label><input type="radio" name="q1b" value="a" /> Slow down and inspect the mechanism, flows and evidence.</label>
    <label><input type="radio" name="q1b" value="b" /> Ignore the data if the team sounds confident.</label>
    <label><input type="radio" name="q1b" value="c" /> Wait for social media to decide.</label>
  </fieldset>
  <fieldset data-answer="c">
    <legend>What makes a Tao Outsider reader different?</legend>
    <label><input type="radio" name="q1c" value="a" /> They collect more tabs than everyone else.</label>
    <label><input type="radio" name="q1c" value="b" /> They memorize ticker symbols.</label>
    <label><input type="radio" name="q1c" value="c" /> They can explain the work, the incentive and the risk in plain English.</label>
  </fieldset>
...
<nav class="course-nav" aria-label="Field School navigation">
  <a href="/field-school/review/bittensor-field-school-useful-work/">Previous: Bittensor is a market for measuring useful work</a>
  <a href="/field-school/review/bittensor-field-school-subnets/">Next: Subnets are incentive machines</a>
</nav>
