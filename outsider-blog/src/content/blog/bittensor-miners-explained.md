...
image: "/blog/basic-seo/bittensor-miners-explained-og.jpg"
imageAlt: "Tao Outsider Bittensor basic guide"
ogImage: "/blog/basic-seo/bittensor-miners-explained-og.jpg"
---

# What are miners in Bittensor?

## Fast answer

Bittensor miners are workers inside subnet markets. They do not mine hashes. They perform the task a subnet asks for, then compete to score well under that subnet mechanism.

This article is for the reader searching "Bittensor miners" and trying to avoid the usual shortcut explanations. The goal is a clean starting point, then a practical path for checking the claim inside the Bittensor ecosystem.

## Plain English version

A miner might serve model outputs, search for molecules, process data, provide compute or respond to a validator challenge. The subnet defines what good work means.
...
People search for Bittensor miners because Bittensor can sound simple from far away and complex as soon as they open the first dashboard. The words repeat everywhere: TAO, subnet, miner, validator, alpha, Root, dTAO, Yuma, staking.
...
Mining TAO changes from subnet to subnet. Each subnet has its own requirements, hardware profile, code and scoring method.
...
1. Choose a subnet before asking how to mine.
2. Read the miner repo.
3. Estimate hardware and operating costs.
4. Study how validators score miners.
